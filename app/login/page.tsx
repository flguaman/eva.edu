                ...
                <SelectContent>
                  <SelectItem value="student">
                    <div className="flex items-center space-x-3 py-2">
                      ...
                      <div>
                        <div className="font-medium">{t("login.student")}</div>
                        <div className="text-xs text-muted-foreground">{t("login.student.desc")}</div>
                      </div>
                    </div>
                  </SelectItem>
                  <SelectItem value="teacher">
                    <div className="flex items-center space-x-3 py-2">
                      ...
                      <div>
                        <div className="font-medium">{t("login.teacher")}</div>
                        <div className="text-xs text-muted-foreground">{t("login.teacher.desc")}</div>
                      </div>
                    </div>
                  </SelectItem>
                  <SelectItem value="admin">
                    <div className="flex items-center space-x-3 py-2">
                      ...
                      <div>
                        <div className="font-medium">{t("login.admin")}</div>
                        <div className="text-xs text-muted-foreground">{t("login.admin.desc")}</div>
                      </div>
                    </div>
                  </SelectItem>
                  <SelectItem value="representative">
                    <div className="flex items-center space-x-3 py-2">
                      ...
                      <div>
                        <div className="font-medium">{t("login.representative")}</div>
                        <div className="text-xs text-muted-foreground">{t("login.representative.desc")}</div>
                      </div>
                    </div>
                  </SelectItem>
                </SelectContent>
